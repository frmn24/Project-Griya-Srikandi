                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-body">
                                    <form action="register.php" method="post"> <!-- Ganti "register.php" dengan aksi sesuai kebutuhan -->
                                        <div class="row mb-3">
                                            <div class="col-md-6">
                                        ...
                                        <div class="mt-4 mb-0">
                                            <div class="d-grid"><button class="btn btn-primary btn-block" type="submit" name="create_account">Create Account</button></div>
                                        </div>
                                    </form>
                                </div>
